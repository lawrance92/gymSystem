...
<body>
    ...
    <!-- ===========================
    =====>> About <<===== -->
    <section id="about-area" class="pt-150">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 ">
                    <div class="about-left media">
                        <div class="about-left-text">
                            <h2>we are people who know what you need</h2>
                        </div>
    ...
    <!-- ===========================
    =====>> Counter <<===== -->
    <div id="counter-area" class="pt-100 pb-150">
        <div class="container">
            <div class="row">
                <!-- Counter Item -->
                ...
                <!-- Counter Item -->
                <div class="col-lg-3 col-md-6">
                    <div class="counter-item mt-50">
                        <i class="flaticon-heart"></i>
                        <span class="counter">457</span><sup>+</sup>
